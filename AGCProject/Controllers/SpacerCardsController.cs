...
namespace AGCProject.Controllers
{
    public class SpacerCardsController : Controller
    {
        ...
        public async Task<IActionResult> LengthCalculator(int? id)
        {
            if (id == null)
            {
                return NotFound();
        ...
        public async Task<IActionResult> Create([Bind("ID,Active,HorizontalGearCaseDeviation,HorizontalCarrierDeviation,Bearing,HMDGear,VerticalGearCaseDeviation,VerticalCarrierDeviation,GearMount,VMDGear,DriveNumber,OperatorID,Date")] SpacerCard spacerCard)
        {
